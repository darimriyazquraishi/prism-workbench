  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto bg-[#181818] p-3 gap-3 font-sans text-xs select-none">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 min-h-[440px]">
        {/* Window 1 Card */}
        <div className="bg-[var(--bg-primary)] border border-[#2d2d2d] rounded-lg overflow-hidden flex flex-col shadow-lg">
          <div className="h-7 bg-[var(--bg-surface)] border-b border-[#2d2d2d] px-3 flex items-center justify-between font-mono text-[11px]">
            ...
            <button
              ...
              className="px-2 py-0.5 rounded bg-[#37373d] hover:bg-[var(--accent-fuchsia)] text-[var(--text-primary)] flex items-center gap-1 cursor-pointer text-[10px]"
            >
        ...
        <div className="bg-[var(--bg-primary)] border border-[#2d2d2d] rounded-lg overflow-hidden flex flex-col shadow-lg">
          <div className="h-7 bg-[var(--bg-surface)] border-b border-[#2d2d2d] px-3 flex items-center justify-between font-mono text-[11px]">
            <span className="font-bold text-[var(--text-primary)] flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-[var(--status-healthy)]"></span>
      ...
      <div className="bg-[var(--bg-primary)] border border-[#2d2d2d] rounded-lg overflow-hidden flex flex-col min-h-[380px] shadow-lg">
        <div className="h-7 bg-[var(--bg-surface)] border-b border-[#2d2d2d] px-3 flex items-center justify-between font-mono text-[11px]">
          <span className="font-bold text-[var(--text-primary)] flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-[var(--status-attention)]"></span>
