...
//#endregion
export { NoClientOnlyHint as $, ExpectedNotESMImage as A, InvalidComponentArgs as B, ActionsReturnedInvalidDataError as C, EndpointDidNotReturnAResponse as D, ClientAddressNotAvailable as E, GetStaticPathsExpectedParams as F, LocalsNotAnObject as G, InvalidGetStaticPathsReturn as H, GetStaticPathsInvalidRouteParam as I, MiddlewareNotAResponse as J, LocalsReassigned as K, GetStaticPathsRequired as L, FontFamilyNotFound as M, FontFileUrlNotFound as N, ExpectedImage as O, ForbiddenRewrite as P, MissingSharp as Q, ImageMissingAlt as R, ActionNotFoundError as S, CacheNotEnabled as T, InvalidImageService as U, InvalidGetStaticPathsEntry as V, LocalImageUsedWrongly as W, MissingImageDimension as X, MissingGetFontFileRequestUrl as Y, MissingMediaQueryDirective as Z, slash as _, UnsupportedImageConversion as _t, collapseDuplicateSlashes as a, OnlyResponseCanBeReturned as at, AstroError as b, hasFileExtension as c, PrerenderDynamicEndpointPathCollide as ct, isRemotePath as d, ResponseSentError as dt, NoImageMetadata as et, joinPaths as f, RewriteWithBodyUsed as ft, removeTrailingForwardSlash as g, UnavailableAstroGlobal as gt, removeQueryString as h, StaticClientAddressNotAvailable as ht, collapseDuplicateLeadingSlashes as i, NoMatchingStaticPathFound as it, FailedToFetchRemoteImageDimensions as j, ExpectedImageOptions as k, isInternalPath as l, RemoteImageNotAllowed as lt, removeLeadingForwardSlash as m, SessionStorageSaveError as mt, matchPattern as n, NoMatchingImport as nt, collapseDuplicateTrailingSlashes as o, PageNumberParamNotFound as ot, prependForwardSlash as p, SessionStorageInitError as pt, MiddlewareNoDataOrNextCalled as q, appendForwardSlash as r, NoMatchingRenderer as rt, fileExtension as s, PrerenderClientAddressNotAvailable as st, isRemoteAllowed as t, NoManifestAvailable as tt, isParentDirectory as u, ReservedSlotName as ut, stripRequestBase as v, UnsupportedImageFormat as vt, AstroResponseHeadersReassigned as w, isAstroError as x, trimSlashes as y, i18nNoLocaleFoundInPath as yt, IncompatibleDescriptorOptions as z };
